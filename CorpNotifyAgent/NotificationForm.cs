...
internal sealed class NotificationForm : Form
{
        ...
        Func<Notification, Task> onAcknowledge)
    {
        ...
        _sidebarList.Controls.Add(new Label { AutoSize = false, Width = 244, Height = 34, Text = "��¡�û�С��", ForeColor = Ink, Font = new Font("Segoe UI", 16, FontStyle.Bold), Padding = new Padding(4, 0, 0, 0) });
        _sidebarList.Controls.Add(new Label { AutoSize = false, Width = 244, Height = 32, Text = "��س���ҹ��С�ȷ�������͹�Դ�к�", ForeColor = MutedInk, Font = new Font("Segoe UI", 9.5f), Padding = new Padding(4, 0, 0, 0) });
        _sidebarProgressLabel = new Label { AutoSize = false, Width = 244, Height = 28, Text = $"��ҹ���� 0 �ҡ {notifications.Count}", ForeColor = Ink, Font = new Font("Segoe UI", 10, FontStyle.Bold), Padding = new Padding(4, 8, 0, 0) };
